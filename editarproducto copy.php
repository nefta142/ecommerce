...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <!-- /.container-fluid -->
    <div class="card-body">
    <form method="post" action="panel.php?modulo=subirfoto&id=<?php print $row["id"]?>">
    <div class="row">
                  <?php
                ...
                <div class="form-group">
                <a href="panel.php?modulo=eliminarfoto&id=<?php print $row["id"]?>"><button type="submit" name="actualizar" class="btn btn-primary">Actualizar</button>
                  <a class="btn btn-danger" href="panel.php?modulo=productos" role="button">Cancelar</a>
                </div>
              </form>
            </div>
