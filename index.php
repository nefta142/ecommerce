    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        session_start();
          ...
          $sql = "SELECT id, nombre, email FROM clientes WHERE email=\"$email\" and clave=\"$clave\"";
          //print "<p>$sql</p>";
        ...
        <form method="get">
          ...
          <div class="row">
            ...
            <div class="col-4">
              ...
              <a href="./tienda/index.php"   class="btn btn-warning btn-block">Seguin sin</a>
            </div>
            <!-- /.col -->
          </div>
        </form>
        ...
        <a href="tienda/index.php?modulo=registrocliente" class="text-center">Registro nuevo usuario</a><br>
